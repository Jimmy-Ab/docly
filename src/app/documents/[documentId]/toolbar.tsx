    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-7 shrink-0 flex flex-col items-center justify-center  rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
          ...
          <ChevronsLeftRightEllipsis className="size-4 rotate-90"/>
...
export const Toolbar = () => {
  ...
  return (
    <div className="bg-[#F1F4F9] px-2.5 py-o.5 rounded-[24px] min-h-[40px] flex items-center gap-x-0.5 overflow-x-auto ">
      {sections[0].map((item) => (
